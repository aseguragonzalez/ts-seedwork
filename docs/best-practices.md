...
| `ValidationErrors`       | Command / Query constructor  | Thrown at construction time             |
...
- `ValidationErrors` is thrown when constructing an invalid command or query — it never reaches the bus.
